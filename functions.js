...
// This function should take in two numbers and return a greeting announcing that the 
//sum of those numbers is today's lucky number
...
export function getRandomNumber() {
    ...
    const randoNumber = Math.floor(Math.random() * (0, 5));
